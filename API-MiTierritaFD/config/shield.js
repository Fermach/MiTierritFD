...
module.exports = {
 ...
 csrf: {
  ...
  filterUris: [
    '/api/mitierrita/v1/login',
    '/api/mitierrita/v1/registro',
    '/api/mitierrita/v1/usuario/:id',
    '/api/mitierrita/v1/usuario/habilitar/:id',
    '/api/mitierrita/v1/usuario/deshabilitar/:id',


    '/api/mitierrita/v1/producto',
    '/api/mitierrita/v1/producto/:id'
  ],
  cookieOptions: {
    httpOnly: false,
    sameSite: true,
